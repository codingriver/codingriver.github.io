---
title: "包体大小优化笔记"
subtitle: "AssetBundle大小管理策略（航海项目包体管理）"
date: 2022-01-17T21:51:13+08:00
author: "codingriver"
...
![](../images/2022-01-20-11-34-30.png)
这个AB包文件大小是200M多，过于庞大

![](../images/2022-01-17-21-54-35.png)

将所有图片打包成一个ab文件

![](../images/2022-01-17-21-55-59.png)

![](../images/2022-01-17-21-56-27.png)


![](../images/2022-01-17-21-57-54.png)
...
![](../images/2022-01-18-17-43-57.png)


![](../images/2022-01-18-17-44-40.png)
打包图集正常的


- Font字体划分依赖错误

![](../images/2022-01-19-15-21-59.png)

![](../images/2022-01-19-15-22-30.png)
...
![](../images/2022-01-19-16-15-01.png)

- 多语言文件划分错误
多语言文件应当每个文件一个AB包，玩家选择语言后重启加载对应语言文件的AB包即可
![](../images/2022-01-19-16-56-21.png)

- 有的设置BundleName，有的没有
 第一个文件夹内容设置BundleName，下面三个文件夹内容没有设置
![](../images/2022-01-19-17-00-03.png)

- Shader冗余严重

city AB包  
![](../images/2022-01-20-11-14-53.png)

reet_challenge AB包  
![](../images/2022-01-20-11-24-38.png)

![](../images/2022-01-20-11-41-31.png)

> 解决方案  
> 1. 将所有Shader抽出打成一个独立bundle  
> 2. 配置到工程设置中(需要测试)  
> ![](../images/2022-01-20-11-30-10.png)  
...
- 基类公共状态机冗余
![](../images/2022-01-24-21-54-50.png)  
*每个角色的包内都有该资源*，**需要验证**
-->
#### 图集、图片文件过大
...
![](../images/2022-01-20-11-48-28.png)
...
![](../images/2022-01-20-11-51-05.png)

使用ETC 4Bit压缩后

![](../images/2022-01-20-11-52-38.png)

使用 Crunched ETC 压缩（需要真机测试性能及是否支持该压缩格式），这个格式消耗cpu，进入GPU处理阶段会解压成etc压缩，GPU本身不支持 Crunched ETC压缩  
![](../images/2022-01-20-11-53-24.png)
...
![](../images/2022-01-21-10-24-42.png)

#### 图片素材尺寸合理性需要规划
这个图太大，需要调整策略  
![](../images/2022-01-21-10-27-01.png)  
![](../images/2022-01-21-10-29-35.png)  

![](../images/2022-01-21-10-32-09.png)  

-->
#### FBX文件过大
>![](../images/2022-01-21-11-14-07.png)  
...
现在的FBX配置  
![](../images/2022-01-20-15-39-33.png)
![](../images/2022-01-20-15-38-38.png)  
文件大小是4322kb，打包AB文件大小是1553kb  

修改FBX配置（没有勾选 Resample Curves）
![](../images/2022-01-20-15-41-33.png)  
![](../images/2022-01-20-15-41-49.png)   
文件大小是4322kb,打包AB文件大小是499kb  （这里fbx文件本身大小没变，untiy不修改源文件）  
![](../images/2022-01-20-15-44-33.png)  
...
![](../images/2022-01-20-16-10-03.png)  
![](../images/2022-01-20-16-34-32.png)  
...
>处理Animation时遇到的问题:  
>![](../images/2022-01-24-20-27-28.png)  
> ![](../images/2022-01-24-20-33-18.png)  
...
![](../images/2022-01-20-17-10-26.png)  
*音频长度2分钟15秒*  
...
#### Terrain使用问题
有多个Terrain Data占用太大  
![](../images/2022-01-21-10-55-02.png)  
![](../images/2022-01-21-10-56-27.png)  
...
![](../images/2022-01-21-11-12-10.png)  
...
![](../images/2022-01-20-17-33-07.png)
![](../images/2022-01-20-18-35-15.png)
...
#### Shader过大
![](../images/2022-01-21-10-42-53.png)
...
![](../images/2022-01-27-10-17-42.png)
*左侧蓝色是优化后的，右侧红色是优化前的*
...
```
![](../images/2022-01-26-17-18-18.png)
...
![](../images/2022-01-27-18-39-42.png)
...
材质球keywords默认：
![](../images/2022-01-27-18-48-01.png)  
![](../images/2022-01-27-18-39-42.png)  

材质球指定keywords后  
![](../images/2022-01-27-18-47-30.png)  
![](../images/2022-01-27-18-46-29.png)  
...
![](../images/2022-01-27-18-51-53.png)
...
>![](../images/2022-03-07-11-15-01.png)  
> ![](../images/2022-03-07-11-21-04.png)  
