...
![](image/包体大小优化笔记/2022-01-20-11-34-30.png)
这个AB包文件大小是200M多，过于庞大

![](image/包体大小优化笔记/2022-01-17-21-54-35.png)

将所有图片打包成一个ab文件

![](image/包体大小优化笔记/2022-01-17-21-55-59.png)

![](image/包体大小优化笔记/2022-01-17-21-56-27.png)


![](image/包体大小优化笔记/2022-01-17-21-57-54.png)
...
![](image/包体大小优化笔记/2022-01-18-17-43-57.png)


![](image/包体大小优化笔记/2022-01-18-17-44-40.png)
打包图集正常的


- Font字体划分依赖错误

![](image/包体大小优化笔记/2022-01-19-15-21-59.png)

![](image/包体大小优化笔记/2022-01-19-15-22-30.png)
...
![](image/包体大小优化笔记/2022-01-19-16-15-01.png)

- 多语言文件划分错误
多语言文件应当每个文件一个AB包，玩家选择语言后重启加载对应语言文件的AB包即可
![](image/包体大小优化笔记/2022-01-19-16-56-21.png)

- 有的设置BundleName，有的没有
 第一个文件夹内容设置BundleName，下面三个文件夹内容没有设置
![](image/包体大小优化笔记/2022-01-19-17-00-03.png)

- Shader冗余严重

city AB包  
![](image/包体大小优化笔记/2022-01-20-11-14-53.png)

reet_challenge AB包  
![](image/包体大小优化笔记/2022-01-20-11-24-38.png)

![](../assets/shared/f580a9e0-f580a9e0-2022-01-20-11-41-31.png)

> 解决方案  
> 1. 将所有Shader抽出打成一个独立bundle  
> 2. 配置到工程设置中(需要测试)  
> ![](image/包体大小优化笔记/2022-01-20-11-30-10.png)  
...
- 基类公共状态机冗余
![](image/包体大小优化笔记/2022-01-24-21-54-50.png)  
*每个角色的包内都有该资源*，**需要验证**
-->
#### 图集、图片文件过大
...
![](image/包体大小优化笔记/2022-01-20-11-48-28.png)
...
![](image/包体大小优化笔记/2022-01-20-11-51-05.png)

使用ETC 4Bit压缩后

![](image/包体大小优化笔记/2022-01-20-11-52-38.png)

使用 Crunched ETC 压缩（需要真机测试性能及是否支持该压缩格式），这个格式消耗cpu，进入GPU处理阶段会解压成etc压缩，GPU本身不支持 Crunched ETC压缩  
![](image/包体大小优化笔记/2022-01-20-11-53-24.png)
...
![](image/包体大小优化笔记/2022-01-21-10-24-42.png)

#### 图片素材尺寸合理性需要规划
这个图太大，需要调整策略  
![](image/包体大小优化笔记/2022-01-21-10-27-01.png)  
![](image/包体大小优化笔记/2022-01-21-10-29-35.png)  

![](image/包体大小优化笔记/2022-01-21-10-32-09.png)  

-->
#### FBX文件过大
>![](image/包体大小优化笔记/2022-01-21-11-14-07.png)  
...
现在的FBX配置  
![](image/包体大小优化笔记/2022-01-20-15-39-33.png)
![](image/包体大小优化笔记/2022-01-20-15-38-38.png)  
文件大小是4322kb，打包AB文件大小是1553kb  

修改FBX配置（没有勾选 Resample Curves）
![](image/包体大小优化笔记/2022-01-20-15-41-33.png)  
![](image/包体大小优化笔记/2022-01-20-15-41-49.png)   
文件大小是4322kb,打包AB文件大小是499kb  （这里fbx文件本身大小没变，untiy不修改源文件）  
![](image/包体大小优化笔记/2022-01-20-15-44-33.png)  
...
![](image/包体大小优化笔记/2022-01-20-16-10-03.png)  
![](image/包体大小优化笔记/2022-01-20-16-34-32.png)  
...
>处理Animation时遇到的问题:  
>![](image/包体大小优化笔记/2022-01-24-20-27-28.png)  
> ![](image/包体大小优化笔记/2022-01-24-20-33-18.png)  
...
![](image/包体大小优化笔记/2022-01-20-17-10-26.png)  
*音频长度2分钟15秒*  
...
#### Terrain使用问题
有多个Terrain Data占用太大  
![](../assets/shared/8befc648-8befc648-2022-01-21-10-55-02.png)  
![](../assets/shared/c463cbda-c463cbda-2022-01-21-10-56-27.png)  
...
![](image/包体大小优化笔记/2022-01-21-11-12-10.png)  
...
![](image/包体大小优化笔记/2022-01-20-17-33-07.png)
![](image/包体大小优化笔记/2022-01-20-18-35-15.png)
...
#### Shader过大
![](image/包体大小优化笔记/2022-01-21-10-42-53.png)
...
#### 视频文件
![](image/包体大小优化笔记/2022-01-21-11-07-54.png)  
单个音频AB文件30M，内存占用也是30M左右
最后需要检查是否有优化的可能

#### TextAsset检查
![](image/包体大小优化笔记/2022-01-21-11-24-01.png)
有几个场景Terrain分块后的数据AB包大概是9M左右（只是分块后的数据，没有素材和材质球等）  
这里是Terrain分块后的数据，量比较大，检查是否有优化可能性

#### Mesh Animator使用
![](image/包体大小优化笔记/2022-01-21-11-30-37.png)  
...
![](image/包体大小优化笔记/2022-01-27-10-17-42.png)
*左侧蓝色是优化后的，右侧红色是优化前的*
...
```
![](image/包体大小优化笔记/2022-01-26-17-18-18.png)
...
![](../assets/shared/d7c09780-d7c09780-2022-01-27-18-39-42.png)
...
材质球keywords默认：
![](image/包体大小优化笔记/2022-01-27-18-48-01.png)  
![](../assets/shared/d7c09780-d7c09780-2022-01-27-18-39-42.png)  

材质球指定keywords后  
![](image/包体大小优化笔记/2022-01-27-18-47-30.png)  
![](image/包体大小优化笔记/2022-01-27-18-46-29.png)  
...
![](image/包体大小优化笔记/2022-01-27-18-51-53.png)
...
>![](image/包体大小优化笔记/2022-03-07-11-15-01.png)  
> ![](image/包体大小优化笔记/2022-03-07-11-21-04.png)  
