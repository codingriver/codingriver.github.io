...
![](../images/2023-12-06-20-00-09.png)
...
![](../images/2024-03-13-14-40-51.png)

![](../images/2024-03-13-14-41-58.png)

- 将`UIParticle`去掉后的耗时35毫秒（将particle继续显示通过3d的方式）：

*节省耗时5毫秒，一共移除`UIParticle`组件66个，共33个prefab。*

![](../images/2024-03-13-14-49-07.png)


- 游戏中实际情况优化前：
![](../images/2024-03-13-15-02-46.png)

- 游戏中实际情况禁用`UIParticle`后：
![](../images/2024-03-13-15-04-54.png)

**这里不能参考总耗时，因为游戏业务逻辑在运行，场景有业务在运行，只能参考单项，相对来说也不算准确**

#### ui冗余相机
增加额外的2个drawcall
![](../images/2024-03-13-15-58-27.png)