...
![](image/UI笔记/2023-03-20-11-53-13.png)

![](image/UI笔记/2023-03-20-11-55-36.png)  
*8个drawcall，左右的白色图片合批了，其他都没有合批;再次打开场景显示7个drawcall，左右白色图片、绿色图片合批了，其他都没有合批。*

![](image/UI笔记/2023-03-20-14-27-51.png) 

![](image/UI笔记/2023-03-20-14-30-38.png) 


![](image/UI笔记/2023-03-20-14-31-49.png) 
![](image/UI笔记/2023-03-20-14-46-30.png) 

![](image/UI笔记/2023-03-20-15-19-36.png) 
![](image/UI笔记/2023-03-20-15-47-03.png) 
...
![](image/UI笔记/2023-03-20-20-57-53.png)
...
![](image/UI笔记/2022-10-24-11-51-22.png)
...
![](image/UI笔记/2022-10-25-11-53-38.png)
![](image/UI笔记/2022-10-25-11-22-47.png)
![](image/UI笔记/2022-10-25-11-21-43.png)
![](image/UI笔记/2022-10-25-11-46-37.png)
![](image/UI笔记/2022-10-25-16-32-29.png)
...
mask使用 用来处理动画
![](image/UI笔记/2022-10-25-11-25-46.png)

mask（没用的），没用用的节点动画
![](image/UI笔记/2022-10-25-11-26-26.png)

底图
![](image/UI笔记/2022-10-25-11-26-57.png)
这个底图独自占一个批次，没有使用sprite，不能合批

![](image/UI笔记/2022-10-25-11-27-42.png)
...
![](image/UI笔记/2022-10-25-14-58-37.png)
...
![](image/UI笔记/2022-10-25-15-37-17.png)
![](image/UI笔记/2022-10-25-15-40-49.png)
...
![](image/UI笔记/2022-11-01-15-26-11.png)
...
![](image/UI笔记/2023-12-06-20-00-09.png)


#### 全屏透明图片优化
原始的Overdraw
![](image/UI笔记/2023-01-05-16-19-12.png)

优化后的Overdraw
![](image/UI笔记/2023-01-05-16-20-31.png)
...
![](image/UI笔记/2024-03-13-14-40-51.png)

![](image/UI笔记/2024-03-13-14-41-58.png)

- 将`UIParticle`去掉后的耗时35毫秒（将particle继续显示通过3d的方式）：

*节省耗时5毫秒，一共移除`UIParticle`组件66个，共33个prefab。*

![](image/UI笔记/2024-03-13-14-49-07.png)


- 游戏中实际情况优化前：
![](image/UI笔记/2024-03-13-15-02-46.png)

- 游戏中实际情况禁用`UIParticle`后：
![](image/UI笔记/2024-03-13-15-04-54.png)

**这里不能参考总耗时，因为游戏业务逻辑在运行，场景有业务在运行，只能参考单项，相对来说也不算准确**

#### ui冗余相机
增加额外的2个drawcall
![](image/UI笔记/2024-03-13-15-58-27.png)