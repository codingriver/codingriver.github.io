...
subtitle: "Cloudflare反向代理工具"
date: 2024-06-26T15:30:25+08:00
author: "codingriver"
...
## [](#a30b795a9f0d4f318b7033fbc82d9ef2 "📝 通过Workers脚本部署设置，手把手带您实现免费高速科学上网，无障碍访问奈菲，ChatGPT")📝 通过Workers脚本部署设置，手把手带您实现免费高速科学上网，无障碍访问奈菲，ChatGPT

### [](#85c01ce2c9ad44a59c17c9a32e2dc65c "脚本部署工具连接")脚本部署工具连接

v2rayN客户端及workers代码都托管在GitHub上，访问时需要科学上网。

#### [](#2a10e6fbf45d426c8ea70cce61c9007e "1、v2rayN下载")1、v2rayN下载

#### [](#8212537df98145c4bb6ee6addc942776 "2、登陆Cloudflare：")2、登陆Cloudflare：

Cloudflare账户注册小布出过一期Zero Trust团队账户设置视频，其中演示了怎么注册Cloudflare账户，不会注册的朋友可以参考那期视频。

#### [](#35b8c6320b884eed8a52689b7bdcb1fe "3、部署workers脚本：")3、部署workers脚本：
...
#### [](#a3975ab394ba4019b8d2b5d87a496a70 "4、套Tls设置v2rayN（建议套上Tls）")4、**套Tls**设置v2rayN（建议套上Tls）
...
## [](#42698158e969418bb25a40710586ef43 "Workers脚本设置步骤")Workers脚本设置步骤

#### [](#800f49eccb0843e1b44c839184b90062 "1、创建workers应用")1、创建workers应用
...
#### [](#48a357babd9b419fb910c9ffa6dba497 "2、添加workers脚本")2、添加workers脚本
...
#### [](#3c5405be2b1f4442aeecd296797b34e5 "3、修改UserID和proxyIP")3、修改UserID和proxyIP
...
#### [](#ed85679615f947f99c30af519ce387e3 "4、生成应用")4、生成应用
...
### [](#466bebf927f94155ac89cfc0141026b0 "获取未加密的Vless订阅连接")获取未加密的Vless订阅连接

#### [](#40df7bc4160c43998f349259a12fc506 "1、 打开连接")1、 打开连接
...
#### [](#1336cf8de45c4d78b39408390e23746d "2、添加UserID")2、添加UserID
...
#### [](#696f3b7474cf4c3c9efc3df19e146e2e "3、生成Vless订阅连接")3、生成Vless订阅连接
...
### [](#48e98b2f248b41c7aed11958fd3af134 "获取Tls加密的Vless订阅连接")获取Tls加密的Vless订阅连接

操作前需确定域名已经成功托管到Cloudflare上

#### [](#a5728adf34ac466e957946f75393ad9b "1、添加自定义域")1、添加自定义域
...
#### [](#ce0838cad1964358bdcd1cec456c7fea "2、 打开连接")2、 打开连接
...
#### [](#398af6a8fd0a483ca4f0daa6ba67e760 "3、生成Vless订阅连接")3、生成Vless订阅连接
...
### [](#d054b753d06d4404959c9afb7a4f0865 "v2rayN客户端设置")v2rayN客户端设置

#### [](#4bab6cbad83e4f8ab9fef70a53d4cb03 "1、添加未套Tls的vless连接")1、添加未套Tls的vless连接
...
#### [](#3869043cc7f8465bac71931e2a5d4eb3 "2、添加已套Tls的vless连接")2、添加已套Tls的vless连接
