...
![](image/EOC-Project-Analysis1/2022-04-14-16-11-38.png)
...
```
![](image/EOC-Project-Analysis1/2022-04-15-16-35-28.png)
...
![](image/EOC-Project-Analysis1/2022-04-20-15-26-15.png)
...
![](image/EOC-Project-Analysis1/2022-03-29-11-10-55.png)
设置登录信息，并且派发登录事件（线上模式）
![](image/EOC-Project-Analysis1/2022-03-29-11-11-38.png)
链接服务器
![](image/EOC-Project-Analysis1/2022-03-29-11-09-55.png)
连接服务器后进行重定向，再次连接服务器，并且验证；重定向且验证后表示登录成功

登录成功后获取角色列表
![](image/EOC-Project-Analysis1/2022-03-29-11-23-25.png)

获取角色回调后后使用第一个角色
![](image/EOC-Project-Analysis1/2022-03-29-11-34-28.png)
![](image/EOC-Project-Analysis1/2022-03-29-11-37-20.png)

使用第一个角色进行登录，登录角色服  
`发送: SprotoType.Role_RoleLogin`
![](image/EOC-Project-Analysis1/2022-03-29-11-38-52.png)

收到登录角色服的回调，返回角色信息
![](image/EOC-Project-Analysis1/2022-03-29-12-00-56.png)

![](image/EOC-Project-Analysis1/2022-03-29-12-03-44.png)

![](image/EOC-Project-Analysis1/2022-03-29-12-08-10.png)
...
![](image/EOC-Project-Analysis1/2022-03-29-14-40-41.png)

#### 相机位置初始化

相机参数初始化
![](image/EOC-Project-Analysis1/2022-03-29-14-43-09.png)

![](image/EOC-Project-Analysis1/2022-03-29-14-05-26.png)

![](image/EOC-Project-Analysis1/2022-03-29-14-02-22.png)
![](image/EOC-Project-Analysis1/2022-03-29-14-09-10.png)
...
>![](image/EOC-Project-Analysis1/2022-03-29-14-08-18.png)  
>![](image/EOC-Project-Analysis1/2022-03-29-14-07-12.png)  
>![](image/EOC-Project-Analysis1/2022-03-29-14-10-28.png)  
...
#### 地图单位初始化
初始化添加单位及更新单位数据
![](image/EOC-Project-Analysis1/2022-03-29-14-58-41.png)
![](image/EOC-Project-Analysis1/2022-03-29-15-11-14.png)
相机视野改变，调整单位
![](image/EOC-Project-Analysis1/2022-03-29-15-12-38.png)
...
```
![](image/EOC-Project-Analysis1/2022-03-29-16-49-32.png)
![](image/EOC-Project-Analysis1/2022-03-29-16-49-51.png)
